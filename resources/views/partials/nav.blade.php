                    ...
                    &nbsp;<li class="dropdown">
                        <a href="#"
                           ...
                           data-toggle="dropdown" role="button" aria-expanded="false" aria-haspopup="true">
                            Warehouses <span class="caret"></span>
                        </a>

                        <ul class="dropdown-menu">
                            <li>
                                <a href="{{ route('warehouses.create') }}">Create</a>
                                <a href="{{ route('warehouses.index') }}">View all</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                ...
                                <a href="{{ route('suppliers.index') }}">View all</a>
                            </li>
                        </ul>
                    </li>
